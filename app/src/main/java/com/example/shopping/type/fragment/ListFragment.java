...
//
    ...
    public View initView() {
        View view = View.inflate(my_Context, R.layout.fragment_list, null);
...
//                    Toast.makeText(mContext, "http", Toast.LENGTH_SHORT).show();
                    if (response != null) {
                        ...
                        if (isFirst) {
                            leftAdapter = new TypeLeftAdapter(my_Context);
                        ...
                        //解析右边数据
                        TypeRightAdapter rightAdapter = new TypeRightAdapter(my_Context, result);
